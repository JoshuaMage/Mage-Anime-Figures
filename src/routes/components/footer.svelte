  ...
  <div class="grid grid-cols-4 sm:gap-1">
    ...
    <section class="md:font-semibold ">
      ...
      <section class="flex justify-center sm:gap-1 md:gap-6 mt-2">
        ...
        <button  class="transform transition-transform duration-300 hover:rotate-180" aria-label="Google"
          ><svg
            height="30px"
            width="30px"
            version="1.1"
        ...
        <button class="transform transition-transform duration-300 hover:rotate-180" aria-label="Facebook">
          <svg
            height="30px"
            width="30px"
            version="1.1"
          ...
          <button class="transform transition-transform duration-300 hover:rotate-180" aria-label="Apple">
            <svg
            height="30px"
            width="30px"
            version="1.1"
